...
#if Android
    private static readonly DirectoryInfo exportDir = new($"{Application.persistentDataPath}/TONX_DATA/OptionOutputs");
#elif Windows
    private static readonly DirectoryInfo exportDir = new("./TONX_DATA/OptionOutputs");
#endif
