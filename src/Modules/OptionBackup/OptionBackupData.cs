...
public class OptionBackupData
{
    ...
    public OptionBackupData(IGameOptions option)
    {
        ...
        foreach (RoleTypes role in new RoleTypes[] { RoleTypes.Scientist, RoleTypes.GuardianAngel, RoleTypes.Engineer, RoleTypes.Noisemaker, RoleTypes.Tracker, RoleTypes.Detective, RoleTypes.Judge, RoleTypes.Shapeshifter, RoleTypes.Phantom, RoleTypes.Viper })
        {
